...
function EventImageCarousel() {
    const dummyImages = ["https://cdn.britannica.com/55/174255-050-526314B6/brown-Guernsey-cow.jpg", "https://cff2.earth.com/uploads/2023/05/16064103/Farms-960x640.jpg"]
    return (
        <View 
        style={{
          width: "100%",
