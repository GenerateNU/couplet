    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ marginLeft: 15, marginRight: 15 }}>
                <Image source={NOTIFICATION_TOGGLE} style={{ height: 250, width: 250}} resizeMode="contain" />
                <View style={{ flexDirection: 'row', width: "93%"}}>
                    <Image source={NOTIFICATION_ICON} style={{ height: 25, width: 25, marginTop: 5 }} resizeMode="contain" />
                    <OnboardingTitle text="Turn on notifications" />
                </View>
                
                <Text style={styles.notificationMessage}> Know when you get a match! </Text>
                <ContinueButton onPress={() => onAllowNotifactionsPressed() } title="Notify Me" isDisabled={false} />
                <TouchableOpacity
